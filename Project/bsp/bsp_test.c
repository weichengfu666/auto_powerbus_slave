...
typedef struct LED_Display{
    ...
    u8 waveBreathChangeFlash_low;
    u8 waveBreathChangeFlash_high;
    u8 waveBreath_now;
}LED_DisplayTypedef;
...
void LED_displayPackPlayer( u8 _PACK_id )
{
    ...
    if( _PACK_id == 0 )
    {
        ...
        {
            LED_breathInit( LED_Display->PWMxx, LED_Display->breath_state, LED_Display->pin_level, LED_Display->periodBreathFlash1_cntCmp, LED_Display->periodChangeFlash2_cntCmp,
                                    LED_Display->waveBreathChangeFlash_low, LED_Display->waveBreathChangeFlash_high, LED_Display->waveBreath_now);
        }
